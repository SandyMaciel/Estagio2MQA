class DoacaoMaterialsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @doacao_material.save
        format.html { redirect_to @doacao_material, notice: 'Doacao material was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @doacao_material.update(doacao_material_params)
        format.html { redirect_to @doacao_material, notice: 'Doacao material was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to doacao_materials_url, notice: 'Doacao material was successfully destroyed.' }
